  ...
  pinnedRepos: [
    {
      ...
      language: 'Python',
      stars: 12,
      url: 'https://github.com/angelonavarro/smart-change-analyzer',
    },
    {
      name: 'ims-decoder',
      ...
      language: 'Python',
      stars: 8,
      url: 'https://github.com/angelonavarro/ims-decoder',
    },
    {
      ...
      language: 'Python',
      stars: 15,
      url: 'https://github.com/angelonavarro/cdr-validation-tool',
    },
    {
      name: 'j-pdve',
      ...
      language: 'TypeScript',
      stars: 5,
      url: 'https://github.com/angelonavarro/j-pdve',
    },
    {
      name: 'portfolio',
      ...
      language: 'TypeScript',
      stars: 3,
      url: 'https://github.com/angelonavarro/portfolio',
    },
    {
      ...
      language: 'Python',
      stars: 7,
      url: 'https://github.com/angelonavarro/telecom-scripts',
    },
  ],
  totalCommits: 500,
  topLanguages: [
